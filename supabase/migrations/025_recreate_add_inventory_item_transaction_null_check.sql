-- Migration: Recreate add_inventory_item_transaction function with NULL v_sku_id check
-- Drops the existing function if it exists, then creates a new one with better error handling
