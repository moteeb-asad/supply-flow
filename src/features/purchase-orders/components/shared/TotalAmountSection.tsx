  ...
  return (
    <div className="px-6 py-6 border-t border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/80 backdrop-blur-md">
      ...
      <div className="flex gap-3">
        ...
        <button
          className="flex-1 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold py-3 px-4 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all active:scale-[0.98] cursor-pointer"
          onClick={onCancel}
          type="button"
        >
          Cancel
