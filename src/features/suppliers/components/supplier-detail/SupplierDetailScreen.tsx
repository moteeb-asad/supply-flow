    ...
    <>
      ...
      <div className="px-8">
        <div className="flex border-b border-[#d0d7e7] gap-8">
          ...
          <a
            className="flex flex-col items-center justify-center border-b-[3px] border-transparent text-[#4e6797] pb-[13px] pt-4 hover:text-primary transition-colors"
            href="#"
          >
            <p className="text-sm font-bold leading-normal tracking-wide">
              Delivery History
      ...
      <div className="p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white flex flex-col gap-2 rounded-xl p-6 border border-[#d0d7e7] shadow-sm">
            <p className="text-[#4e6797] text-sm font-medium">
              Avg Lead Time
            </p>
            <div className="flex items-baseline gap-2">
              <p className="text-[#0e121b] text-3xl font-black">
                3.2 Days
              </p>
        ...
        <div className="bg-white rounded-xl border border-[#d0d7e7] p-6 shadow-sm">
          ...
          <div className="h-64 relative bg-slate-50 rounded flex items-end justify-between px-8 pb-4 border border-dashed border-slate-200">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <div className="relative">
                ...
                <input
                  className="pl-10 pr-4 py-2 bg-white border border-[#d0d7e7] rounded-lg text-sm w-64 focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all"
                  placeholder="Search PO#"
                  type="text"
                />
              </div>
              <button className="px-4 py-2 bg-white border border-[#d0d7e7] rounded-lg text-sm font-bold flex items-center gap-2">
          ...
          <div className="bg-white rounded-xl border border-[#d0d7e7] shadow-sm overflow-hidden">
            ...
            <div className="px-6 py-4 flex items-center justify-between bg-slate-50">
              ...
              <div className="flex gap-2">
                <button
                  className="px-3 py-1 bg-white border border-[#d0d7e7] rounded text-xs font-bold disabled:opacity-50"
                  disabled={"disabled" as unknown as boolean}
                >
                  Previous
                </button>
                <button className="px-3 py-1 bg-white border border-[#d0d7e7] rounded text-xs font-bold hover:bg-slate-50">
                  Next
                </button>
              </div>
            </div>
